...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Channel 1', url='https://t.me/+3i-QfoPlzmVjMjI1'),
      InlineKeyboardButton('💬 channel 2', url='https://t.me/+K__frpdkHtw4ZGQ1')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 Channel 3', url='https://t.me/+iSEdrF2tNlxhMzBl')
    ],[
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton('📢 Updates', url='https://t.me/+K__frpdkHtw4ZGQ1'),
                InlineKeyboardButton('💬 Support', url='https://t.me/+K__frpdkHtw4ZGQ1')
                ],[
                InlineKeyboardButton('⚙️ Help', callback_data='help'),
